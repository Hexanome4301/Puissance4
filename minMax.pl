...
simulAdversaire(Joueur,ProfondeurEnCours,ListeDeCoup,PirePoids,PireCoup):-
	...
	simulationCoup(Adversaire,Colonne,NewGamestate), %adversaire de m (l'ia)
...
meilleurCoup(PoidsDuCoupActuel,PoidsDuCoupSuivant,PirePoids,CoupAssocie,_,MeilleurCoup):-
...
pireCoup(PoidsDuCoupActuel,PoidsDuCoupSuivant,MeilleurCoup,CoupAssocie,_,PireCoup):-
